...
async function initializeCounter() {
    ...
    // Se não encontrar o documento (o que significa que o contador ainda não foi inicializado), cria um novo documento 
    //com o _id 'cliente_id' e a sequência inicializada com 0.
    if (!count) {
